...
// Specifics
// "Falar com especialista" buttons originally bg-nc-blue -> bg-nc-trust-green
// I'll just change bg-nc-navy-dark back to bg-nc-trust-green where it's a button.
...
// Fix remaining specific buttons
