...
// Read the fresh color-replaced App.tsx
...
// Mod 3: Hero Image
content = content.replace('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=80', '/broker-contract.png');
...
const getBlock = (idStr, isFooter=false) => {
  ...
  let endIdx;
  if(isFooter) {
    endIdx = content.indexOf('</footer>') + 9;
  } else {
...
// Reorder sections for conversion optimization:
// 1. Header
// 2. Hero
// 3. Indicadores
// 4. Institucional
