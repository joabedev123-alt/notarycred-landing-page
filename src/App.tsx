...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* 1. HEADER */}
      <header className="fixed top-0 w-full bg-nc-navy-dark/95 backdrop-blur-md z-50 shadow-sm border-b border-white/10">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/logo04.png" alt="NotaryCred" className="h-[75px] w-auto object-contain" />
          </div>
      ...
      {/* 2. HERO PRINCIPAL */}
      <section id="inicio" className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-nc-navy-dark text-white relative overflow-hidden">
      ...
      <section className="py-20 lg:py-32 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-20">
          <motion.div 
             ...
             className="lg:w-1/2 relative"
          >
            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl max-w-md mx-auto lg:mx-0 lg:ml-auto">
              <img src="/simple-house.png" alt="Casa de classe média" className="w-full h-auto object-cover aspect-square hover:scale-105 transition-transform duration-700" />
            </div>
          ...
          <motion.div 
             ...
             className="lg:w-1/2"
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 mb-8 tracking-tight">O que a <span className="text-nc-teal-title">NotaryCred</span> faz por você?</h2>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-nc-navy-dark text-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full relative overflow-hidden">
              ...
              <a href={WHATSAPP_LINK} className="w-full block text-center bg-nc-trust-green text-nc-teal-title hover:bg-nc-tech-blue px-6 py-3 rounded-full font-bold transition-colors relative z-10">
      ...
      <section className="py-20 lg:py-32 bg-[#0F1724] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-20">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex justify-between items-end mb-2">
                    <div>
                      <h4 className="text-white font-bold">NotaryCred</h4>
                      <p className="text-slate-400 text-xs">Garantia de Imóvel</p>
                    </div>
                    <span className="text-nc-trust-green font-black text-xl">1.30%</span>
                  </div>
                  <div className="w-full bg-slate-800 rounded-full h-2">
                    <div className="bg-nc-trust-green h-2 rounded-full shadow-[0_0_10px_rgba(24,158,79,0.5)]" style={{ width: '15%' }}></div>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between items-end mb-2">
                    <div>
                      <h4 className="text-white font-bold">Empréstimo Pessoal</h4>
                      <p className="text-slate-400 text-xs">Banco tradicional</p>
                    </div>
                ...
                <div>
                  <div className="flex justify-between items-end mb-2">
                    <div>
                      <h4 className="text-white font-bold">Cartão Rotativo</h4>
                      <p className="text-slate-400 text-xs">Crédito rotativo</p>
                    </div>
          ...
          >
            ...
            <ul className="space-y-5 mb-10">
              {[
                ...
                <li key={idx} className="flex items-start gap-4 text-slate-200">
                  <div className="mt-1 w-6 h-6 rounded-full bg-nc-trust-green/20 flex items-center justify-center flex-shrink-0">
                    <i className="bi bi-check text-nc-trust-green text-lg"></i>
                  </div>
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="inline-block bg-nc-trust-green text-white px-8 py-4 rounded-xl font-bold hover:bg-nc-trust-green/90 transition-colors shadow-lg shadow-nc-trust-green/20">
              Simule seu crédito
            </a>
          </motion.div>
        </div>
